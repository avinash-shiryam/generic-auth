...
class ConfigVariable:
    ...
    COGNITO_KEYS_URL = "https://cognito-idp.{}.amazonaws.com/{}/.well-known/jwks.json".format(AWS_REGION, COGNITO_USER_POOL_ID)
    ...
    CAPTCHA_URL = "https://www.google.com/recaptcha/api/siteverify?secret={}&response={}"
